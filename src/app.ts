...
import { projectLinks, projectLinksStyles } from "./project-links.js";
...
.brand{color:var(--ink);text-decoration:none;display:flex;gap:12px;align-items:center;font:800 16px/1 ui-monospace,SFMono-Regular,monospace;letter-spacing:.08em}.mark{width:25px;height:25px;background:var(--lime);border-radius:50% 50% 4px 50%;transform:rotate(45deg)}
.brand:focus-visible,.nav a:focus-visible{outline:2px solid var(--lime);outline-offset:8px}.status,.nav a{font:700 11px/1 ui-monospace,monospace;color:var(--lime)}.nav{display:flex;gap:22px;align-items:center}.nav a{text-decoration:none}.hero{padding-top:92px;padding-bottom:80px}.kicker,.site span,.empty span,.agent-copy span{font:700 11px/1 ui-monospace,monospace;letter-spacing:.14em;color:var(--lime)}
...
.sites{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.site,.empty{min-width:0;min-height:210px;padding:26px;background:var(--panel);border:1px solid var(--line);color:inherit;text-decoration:none;transition:.18s ease}.site:hover{transform:translateY(-4px);border-color:var(--lime)}.site h3,.empty h3{overflow-wrap:anywhere;font-size:30px;margin:58px 0 10px;letter-spacing:-.04em}.empty{grid-column:1/-1;background:linear-gradient(120deg,#171716,#222518)}
footer{margin-top:100px;padding-top:34px;padding-bottom:60px;border-top:1px solid var(--line);display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:24px;color:var(--muted);font:700 11px ui-monospace,monospace}footer p{margin:10px 0 0}
${projectLinksStyles}
...
</style></head><body><header><a class="brand" href="/" aria-label="OpenQuick home"><span class="mark" aria-hidden="true"></span>OPENQUICK</a><nav class="nav">${proEnabled ? '<a href="/pro">PRO ↗</a>' : ''}<a href="/join">AGENT JOIN →</a><div class="status">● SYSTEM READY</div></nav></header>
...
<footer><div><span>OPEN SOURCE / RAILWAY READY</span><p>KEEP IT SMALL. MAKE IT USEFUL.</p></div>${projectLinks()}</footer></body></html>`;
}
