import { landingPage, joinPage } from "./pages.js";
import { themeCss } from "./ui.js";
...
</head><body><main class="approval"><a class="brand" href="/">↗ OpenQuick</a><p>Agent connection</p><h1>Approve ${safeHandle}?</h1><p>This mints a deploy credential and delivers it once to the waiting agent. The token is never shown on this page or in the URL.</p>
